...
// class ElectricianProvider with ChangeNotifier {
...
//           .collection('Worker')
//           .where('categories', arrayContains: 'Electrician')
//           .get();
...
//       Provider.of<ElectricianProvider>(context, listen: false).fetchElectricians();
//     });
//   }

//   @override
//   Widget build(BuildContext context) {
//     final electricianProvider = Provider.of<ElectricianProvider>(context);
...
//               onChanged: (value) {
//                 electricianProvider.searchElectricians(value);
//               },
...
//           ),
//           Expanded(
//             child: electricianProvider.isLoading
//                 ? const Center(
//                     child: CircularProgressIndicator(
//                       valueColor: AlwaysStoppedAnimation<Color>(greenColor),
//                     ),
//                   )
//                 : electricianProvider.Electricians.isEmpty
//                     ? const Center(
//                         child: Text(
...
//                         itemCount: electricianProvider.Electricians.length,
//                         itemBuilder: (context, index) {
//                           var electrician = electricianProvider.Electricians[index];
...
class ElectricianProvider with ChangeNotifier {
  ...
  final Map<String, Map<String, String>> _translations = {
    'en': {
      'fetchError': 'Failed to fetch electricians',
    },
    'ur': {
      'fetchError': 'الیکٹریشنز لانے میں ناکامی',
    },
  };
  ...
  Future<void> fetchElectricians(String language) async {
    _isLoading = true;
    notifyListeners();
    try {
      QuerySnapshot snapshot = await FirebaseFirestore.instance
...
class _ElectriciansState extends State<Electricians> {
  ...
  final Map<String, Map<String, String>> _translations = {
    'en': {
      'appTitle': 'Electricians',
      'searchHint': 'Search by City...',
      'noElectriciansFound': 'No electricians found',
      'experienceLabel': 'Experience: {years} years',
    },
    'ur': {
      'appTitle': 'الیکٹریشنز',
      'searchHint': 'شہر کے لحاظ سے تلاش کریں...',
      'noElectriciansFound': 'کوئی الیکٹریشن نہیں ملا',
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      Provider.of<ElectricianProvider>(context, listen: false).fetchElectricians(language);
    });
  }
          ...
          Expanded(
            child: electricianProvider.isLoading
                ...
                : electricianProvider.electricians.isEmpty
                    ? Center(
                        child: Text(
                          _translate('noElectriciansFound', language),
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      _translate('experienceLabel', language,
                                          placeholder:
                                              electrician['experience']?.toString() ?? 'N/A'),
                                      style: TextStyle(
                                        color: subtitleColor,
                                        fontSize: 14,
                                        fontFamily: isUrdu ? 'NotoNastaliqUrdu' : null,
