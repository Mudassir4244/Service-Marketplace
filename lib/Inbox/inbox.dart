...
class ChatSelectionProvider extends ChangeNotifier {
  ...
  Future<void> hideChats(Set<String> chatIds) async {
    ...
    final hiddenChatsRef = _firestore
...
class _InboxState extends State<Inbox> with SingleTickerProviderStateMixin {
  ...
  Future<void> deleteSelectedChats(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 12),
                            Text(
                              customerProvider.userData?['name'] ??
                                  _translate('profileName', language),
                              style: TextStyle(
                                fontSize: 22,
                                fontWeight: FontWeight.bold,
                                color: Colors.white,
                              ...
                              builder: (context, snapshot) {
                                ...
                                if (snapshot.hasError) {
                                  return Center(
                                    child: Text(
                                      _translate(
                                          'errorFetchingChats', language),
                                      style: TextStyle(
                                        color: textColor,
                                        fontFamily:
                                            isUrdu ? 'NotoNastaliqUrdu' : null,
                                      ),
                                      // textDirection: isUrdu ? TextDirection.rtl : TextDirection.ltr,
                                    ),
                                  );
                                ...
                                final filteredDocs = docs.where((doc) {
                                  ...
                                  final displayName =
                                      getDisplayName(data).toLowerCase();
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final isSelected = selectionProvider
                                        ...
                                        .contains(docId);
                                    final receiverUid =
                                        getOtherUserId(data['participants']);
