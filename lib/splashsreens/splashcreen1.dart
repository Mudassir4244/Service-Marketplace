...
// class Splashcreen1 extends StatefulWidget {
//   const Splashcreen1({super.key});

//   @override
//   State<Splashcreen1> createState() => _Splashcreen1State();
// }

// class _Splashcreen1State extends State<Splashcreen1> {
//   @override
...
//                         color: const Color.fromARGB(70, 57, 128, 250)),
//                       child: Center(
...
//               ),
//               SizedBox(height: 30,),
//               Center(child: Flexible(child: Image.asset('assets/splashscreen1.png'))),
//               SizedBox(height: 5),
//               GestureDetector(
//                 onTap: (){},
//                 child: Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: AnimatedOpacity(
                      ...
                      child: Container(
                        ...
                        height: 30,
                        decoration: BoxDecoration(
                          color: Color.fromARGB(70, 57, 128, 250),
                          borderRadius: BorderRadius.circular(30),
                          boxShadow: [
                            BoxShadow(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      try {
                        ...
                        print("Navigation error to Splashscreen2: $e");
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text('Error: $e'),
                            backgroundColor: Colors.red,
