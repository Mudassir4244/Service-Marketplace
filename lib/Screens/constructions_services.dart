...
// class ConstructionsServices extends ChangeNotifier {
...
//     final checkboxprovider = Provider.of<ConstructionsServices>(context);
...
//         ),
//       ),
//       body: Consumer<ConstructionsServices>(
...
//                         checkboxProvider,
//                         index,
//                         ConstructionsServices._categoryNames[index],
//                         ConstructionsServices._categoryImages[index],
//                         isDarkMode,
//                       ),
...
//     ConstructionsServices provider,
//     int index,
//     String title,
//     String imagePath,
//     bool isDarkMode,
...
class ConstructionServicesScreen extends StatelessWidget {
   ConstructionServicesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          _translate('constructionServices', language),
          style: TextStyle(
            fontWeight: FontWeight.bold,
            color: Colors.white,
                  ...
                  return Column(
                    children: [
                      _buildCategoryTile(
                        ...
                        checkboxProvider,
                        index,
                        ConstructionsServices._categoryTranslations[language]![index],
                        ConstructionsServices._categoryImages[index],
                        isDarkMode,
                        isUrdu,
                      ),
