...
// class electricianIndividuals extends StatelessWidget {
//   final Map<String, dynamic> electricians; // Receive electricians details

//   const electricianIndividuals({super.key, required this.electricians});
...
//         centerTitle: true,
//         title: Text(
//           electricians['name'] ?? 'electricians Profile',
...
//                       onTap: (){
//                         Navigator.push(context, MaterialPageRoute(builder: (context)=>chatscreen(workers: electricians,)));
//                       },
//                       child: Container(
//                         height: 60,
...
//               if (electricians['categoryImage'] != null) 
//                 ClipRRect(
//                   borderRadius: BorderRadius.circular(15),
//                   child: Image.network(
//                     electricians['categoryImage'] ?? 'https://via.placeholder.com/300', // Placeholder if no image
//                     height: 150,
//                     width: double.infinity,
//                     fit: BoxFit.cover,
...
//                 child: Image.network(
//                   electricians['imageUrl'] ?? 'https://via.placeholder.com/150', // Placeholder if no image
//                   height: 120,
//                   width: 120,
//                   fit: BoxFit.cover,
//                   errorBuilder: (context, error, stackTrace) {
...
//               /// **electricians Details (Bold Labels)**
//               Container(
...
//                     crossAxisAlignment: CrossAxisAlignment.start,
//                     children: [
//                       buildRichText("Name:", electricians['name'] ?? 'N/A'),
//                       const SizedBox(height: 10),

//                       buildRichText("Email:", electricians['email'] ?? 'N/A'),
//                       const SizedBox(height: 10),

//                       // **Tappable Phone Number**
//                       buildRichText("Phone:", electricians['phonenumber'] ?? 'N/A', isPhoneNumber: true),
//                       const SizedBox(height: 10),

//                       buildRichText("City:", electricians['city'] ?? 'N/A'),
//                       const SizedBox(height: 10),

//                       buildRichText("Experience:", "${electricians['experience'] ?? 'N/A'} years"),
//                     ],
//                   ),
//                 ),
//               ),
...
//                   child: buildRichText("Category:", electricians['categories']?.join(', ') ?? 'N/A'),
//                 ))),
//                 SizedBox(
...
import 'package:servable/theme_provider/themeprovider.dart';
import 'package:servable/Inbox/chatscreen.dart';
// import 'package:servable/workers_individuals_profile/electrician_individuals.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:fluttertoast/fluttertoast.dart';

class ElectricianIndividual extends StatefulWidget {
  final Map<String, dynamic> electrician;

  const ElectricianIndividual({super.key, required this.electrician});

  @override
  State<ElectricianIndividual> createState() => _ElectricianIndividualState();
}

class _ElectricianIndividualState extends State<ElectricianIndividual> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          widget.electrician['name'] ?? 'electrician Profile',
      ...
      bottomNavigationBar: Padding(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => chatscreen(workers: widget.electrician)),
            );
          },
          child: Container(
            height: 55,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            CircleAvatar(
              radius: 80,
              backgroundImage: NetworkImage(widget.electrician['imageUrl'] ?? ''),
              ...
              child: widget.electrician['imageUrl'] == null ? const Icon(Icons.person, size: 80) : null,
            ),
            const SizedBox(height: 20),
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildInfo("Name", widget.electrician['name'], isDark),
            _buildInfo("Email", widget.electrician['email'], isDark),
            _buildInfo("Phone", widget.electrician['phonenumber'], isDark, isPhoneNumber: true),
            _buildInfo("City", widget.electrician['city'], isDark),
            _buildInfo("Experience", "${widget.electrician['experience']} years", isDark),
            _buildInfo("Category", widget.electrician['categories']?.join(', ') ?? 'N/A', isDark),
          ],
        ),
      ),
    );
